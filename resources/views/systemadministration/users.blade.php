              ...
              <!-- form start -->
                ...
                <div class="card-body">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      <label>Name</label>
                      <input type="text" class="form-control" placeholder="Name" name="frme_name" value="{{$r->name}}" readonly>
                    </div>
                    <div class="form-group">
                      <label>Email</label>
                      <input type="text" class="form-control" placeholder="URL" name="frme_email" value="{{$r->email}}" readonly>
                    </div>
                    <div class="form-group">
