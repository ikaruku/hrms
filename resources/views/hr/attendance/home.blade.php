  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="col-lg-3 col-6">
        ...
        <a href="{{url('/hr/attendance/record')}}" class="small-box-footer">More info <i
      ...
      <div class="col-lg-3 col-6">
        ...
        <a href="" data-toggle="modal" data-target="#modal-absent" class="small-box-footer">More info <i
          class="fas fa-arrow-circle-right"></i></a>
        </div>
      </div>
