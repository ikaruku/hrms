    ...
    <div class="container-fluid">
      ...
      <div class="col-12">
        ...
        <div class="card-header">
          ...
          <div class="input-group-prepend">
            ...
            <button type="button" class="dropdown-item" data-toggle="modal"
              data-target="#modal-generate">Generate Schedule</button>
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-import">Import
              Data</button>
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-leave">Sync with
              Leave Data</button>
          ...
          <div class="input-group-prepend">
            ...
            <div class="dropdown-menu">
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#modal-export">Export
              Data</button>
        ...
        <div class="card-header">
          ...
          <label><input type="checkbox" name="active" {{ request('active') == 'on' ? 'checked' : '' }}> Show All
            Employees </label>
