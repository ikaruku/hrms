          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-addleave">
                  Add
                </button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $r->notes }}</td>
                    <td>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" onclick="setDeleteUrl('{{url('/hr/attendance/leave/delete')}}/{{ $r->leaveid }}')">
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{url('/hr/attendance/leave/add')}}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="frm_emplid">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control"  name="frm_leavedate">
                  </div>
                  <div class="form-group">
                    <label>Leave Type</label>
                    <select class="form-control select2" style="width: 100%;" name="frm_leavetype">
                      <option value="SD">SD - SICK DOCTOR</option>
                      <option value="UL">UL - UNPAID LEAVE</option>
                      <option value="HD">HD - HALF DAY</option>
                      <option value="AL">AL - ANNUAL LEAVE</option>
                      <option value="ML">ML - MARRIAGE LEAVE</option>
                      <option value="PL">PL - PREGNANT LEAVE</option>
                      <option value="PL">PL - PERIOD LEAVE</option>
                    </select>
                  </div>
                  <div class="form-group">
                    <label>Notes</label>
                    <input type="text" class="form-control"  name="frm_notes">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
...
<div class="modal fade" id="modal-addleave">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{url('/hr/attendance/leave/addleave')}}" method="post">
        <div class="modal-header">
          <h4 class="modal-title">Add Data</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control"  name="frm_fromdate" required>
                  </div>
                  <div class="form-group">
                    <label>To Date</label>
                    <input type="date" class="form-control"  name="frm_todate" required>
                  </div>
                  <div class="form-group">
                    <label>Leave Type</label>
                    <select class="form-control select2" style="width: 100%;" name="frm_leavetype" required>
                      <option value="" disabled selected>Select an option</option>
                      <option value="SD">SD - SICK DOCTOR</option>
                      <option value="UL">UL - UNPAID LEAVE</option>
                      <option value="AL">AL - ANNUAL LEAVE</option>
                      <option value="ML">ML - MARRIAGE LEAVE</option>
                      <option value="PG">PG - PREGNANT LEAVE</option>
                      <option value="PD">PD - PERIOD LEAVE</option>
                      <option value="HD">HD - HALF DAY</option>
                    </select>
                  </div>
                  <div class="form-group">
