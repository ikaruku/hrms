                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" onclick="setDeleteUrl('{{url('/hr/attendance/holiday/delete')}}/{{ $r->id }}')">
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{url('/hr/attendance/holiday/add')}}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control"  name="frm_holidaydate" required>
                  </div>
                  <div class="form-group">
                    <label>Holiday Name</label>
                    <input type="text" class="form-control"  name="frm_holidayname" required>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
...
<div class="modal fade" id="modal-edit{{$r->id}}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <!-- form start -->
      <form action="{{url('/hr/attendance/holiday/update')}}" method="post">
        <div class="modal-body">
        <!-- general form elements -->
          <div class="card card-primary">
              {{ csrf_field() }}
              <div class="card-body">                
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>ID</label>
                    <input type="text" class="form-control"  name="frme_id" value="{{ $r->id }}" readonly>
                  </div>
                  <div class="form-group">
                    <label>Holiday Date</label>
                    <input type="date" class="form-control"  name="frme_holidaydate" value="{{ $r->holidaydate }}">
                  </div>
                  <div class="form-group">
                    <label>Holiday Name</label>
                    <input type="text" class="form-control"  name="frme_holidayname" value="{{ $r->holidayname }}">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
