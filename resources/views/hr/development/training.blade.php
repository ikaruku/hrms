          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <tbody>
                  @foreach($trnlist as $r)
                  <tr>
                    <td>{{ $r->trainingid }}</td>
                    <td>{{ $r->trainingname }}</td>
                    <td>{{ $r->trainer }}</td>
                    <td>
                      <a href="{{url('/hr/development/training\/')}}{{ $r->trainingid }}">
                        <button type="button" class="btn btn-info btn-sm"><i class="far fa-eye"></i></button>
                      </a>
                      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-edit{{$r->trainingid}}"><i class="fas fa-edit"></i></button>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" onclick="setDeleteUrl('{{url('/hr/development/training/delete')}}/{{ $r->trainingid }}')"><i class="far fa-trash-alt"></i></button>
                    </td>
                  </tr>
                  @endforeach
                </table>
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="frm_trainingname" required>
                  </div>
                  <div class="form-group">
                    <label>Trainer</label>
                    <input type="text" class="form-control"  name="frm_trainer" required>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
...
@foreach($trnlist as $r)
<div class="modal fade" id="modal-edit{{$r->trainingid}}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="{{url('/hr/training/update')}}" method="post">
        ...
        <!-- general form elements -->
          <div class="card card-primary">
              {{ csrf_field() }}
              <input type="hidden" name="trainingid" value="{{ $r->trainingid }}"> 
              <div class="card-body">                
                <div class="card-header">
                  <h3 class="card-title">
                    General
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Training Name</label>
                    <input type="text" class="form-control" name="edit_trainingname" value="{{$r->trainingname}}">
                  </div>
                  <div class="form-group">
                    <label>Trainer</label>
                    <input type="text" class="form-control" name="edit_trainer" value="{{$r->trainer}}">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
