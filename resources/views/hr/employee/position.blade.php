              ...
              <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $r->posname }}</td>
                    <td>
                      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-edit{{$r->posid}}"><i class="fas fa-edit"></i></button>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" onclick="setDeleteUrl('{{url('/hr/employee/position/delete')}}/{{ $r->posid }}')"><i class="far fa-trash-alt"></i></button>
                    </td>
                  </tr>
                  @endforeach
                </table>
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{url('/hr/employee/position/add')}}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="frm_posname" required>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
...
@foreach($poslist as $r)
<div class="modal fade" id="modal-edit{{$r->posid}}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <!-- form start -->
      <form action="{{url('/hr/employee/position/update')}}" method="post">
        <div class="modal-body">
        <!-- general form elements -->
          <div class="card card-primary">
              {{ csrf_field() }}
              <input type="hidden" name="posid" value="{{ $r->posid }}"> 
              <div class="card-body">                
                <div class="card-header">
                  <h3 class="card-title">
                    General
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="edit_posname" value="{{$r->posname}}">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
