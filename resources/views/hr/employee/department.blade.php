              ...
              <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $r->deptname }}</td>
                    <td>
                      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-edit{{$r->deptid}}"><i class="fas fa-edit"></i></button>
                      <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" onclick="setDeleteUrl('{{url('/hr/employee/department/delete')}}/{{ $r->deptid }}')"><i class="far fa-trash-alt"></i></button>
                    </td>
                  </tr>
                  @endforeach
                </table>
...
<div class="modal fade" id="modal-add">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{url('/hr/employee/department/add')}}" method="post">
              ...
              <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="frm_deptname" required>
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
...
@foreach($deptlist as $r)
<div class="modal fade" id="modal-edit{{$r->deptid}}">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <!-- form start -->
      <form action="{{url('/hr/employee/department/update')}}" method="post">
        <div class="modal-body">
        <!-- general form elements -->
          <div class="card card-primary">
              {{ csrf_field() }}
              <input type="hidden" name="deptid" value="{{ $r->deptid }}"> 
              <div class="card-body">                
                <div class="card-header">
                  <h3 class="card-title">
                    General
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label>Department Name</label>
                    <input type="text" class="form-control" name="edit_deptname" value="{{$r->deptname}}">
                  </div>
                </div>
              </div>
              <!-- /.card-body -->
