...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      onclick="setDeleteUrl('{{url('/hr/employee/worker/delete')}}/{{ $r->emplid }}')"> Delete User </button>
      <br></br>
      <div class="row">
      <div class="col-md-3">
      <!-- Profile Image -->
      <div class="card card-primary card-outline">
        ...
        <img class="profile-user-img img-fluid img-circle" src="{{url('/storage\/')}}{{ $r->emplpicture }}">
        </div>
      ...
      <div class="card">
        ...
        <li class="nav-item"><a class="nav-link active" href="#basic" data-toggle="tab">Basic Information</a>
        </li>
        ...
        <div class="form-group">
          ...
          <option value="male" <?php  if ($r->gender == 'male')
    echo 'selected'; ?>>Pria</option>
          <option value="female" <?php  if ($r->gender == 'female')
    echo 'selected'; ?>>Wanita</option>
        ...
        <div class="form-group">
          ...
          <option value="Active" <?php  if ($r->status == 'Active')
    echo 'selected'; ?>>Active</option>
          <option value="Resigned" <?php  if ($r->status == 'Resigned')
    echo 'selected'; ?>>Resigned</option>
          <option value="Terminated" <?php  if ($r->status == 'Terminated')
    echo 'selected'; ?>>Terminated
      ...
      @endforeach
        ...
        <div class="form-group">
          ...
          <option value="" disabled selected>Select an option</option>
          <option value="TK0" <?php  if ($r->taxtype == 'TK0')
    echo 'selected'; ?>>TK0</option>
          <option value="TK1" <?php  if ($r->taxtype == 'TK1')
    echo 'selected'; ?>>TK1</option>
          <option value="TK2" <?php  if ($r->taxtype == 'TK2')
    echo 'selected'; ?>>TK2</option>
          <option value="TK3" <?php  if ($r->taxtype == 'TK3')
    echo 'selected'; ?>>TK3</option>
          <option value="K0" <?php  if ($r->taxtype == 'K0')
    echo 'selected'; ?>>K0</option>
          <option value="K1" <?php  if ($r->taxtype == 'K1')
    echo 'selected'; ?>>K1</option>
          <option value="K2" <?php  if ($r->taxtype == 'K2')
    echo 'selected'; ?>>K2</option>
          <option value="K3" <?php  if ($r->taxtype == 'K3')
    echo 'selected'; ?>>K3</option>
          </select>
        </div>
        </div>
      ...
      @endforeach
        ...
        <option value="{{ $schedule->scheduleid }}" @if($schedule->scheduleid == $r->weekdayid) selected
    @endif>
      ...
      @endforeach
        ...
        <div class="form-group">
          ...
          <option value="" disabled selected>Select an option</option>
          @foreach($attschedulelist as $schedule)
        <option value="{{ $schedule->scheduleid }}" @if($schedule->scheduleid == $r->saturdayid) selected
    @endif>
        {{ $schedule->scheduleid }} - {{ $schedule->schedulename }}
        </option>
      @endforeach
  ...
  <div class="modal fade" id="modal-addpos">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control select2" style="width: 100%;" name="frm_deptid" id="deptSelect"
            onchange="updateDeptName()">
            <option value="" disabled selected>Select an option</option>
      ...
      @endforeach
          ...
          <div class="form-group">
            <label>Level</label>
            <select class="form-control select2" style="width: 100%;" name="frm_levelid" id="levelSelect"
      ...
      @endforeach
          ...
          <div class="form-group">
            ...
            <select class="form-control select2" style="width: 100%;" name="frm_positionid" id="positionSelect"
            onchange="updatePositionName()">
            <option value="" disabled selected>Select an option</option>
